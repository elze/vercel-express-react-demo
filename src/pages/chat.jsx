...
export default function HomePage() {
  ...
  const User = (props) => {
    ...
    return (
      <div class="relative flex items-start gap-2 hover:bg-zinc-700 px-5 rounded-md hover:[&_.dismiss]:block" id={uuid} ref={messageRef}>
        <div
        ...
        <div class="flex flex-col w-full max-w-[320px] min-h-[56px] leading-1.5 cursor-pointer hover:bg-zinc-700 group">
          <div class="flex items-center space-x-2 rtl:space-x-reverse group">
            <span class="text-sm font-semibold text-[#727272] group-hover:text-white">{username}</span>
             ...
             <button type="button" class="dismiss none ms-auto -mx-1.5 -my-1.5 bg-white text-gray-400 hover:text-gray-900 rounded-lg focus:ring-2 focus:ring-gray-300 p-1.5 hover:bg-gray-100 inline-flex items-center justify-center h-8 w-8 dark:text-gray-500 dark:hover:text-white dark:bg-gray-800 dark:hover:bg-gray-700" data-dismiss-target={"#" + uuid} aria-label="Close">
